...
class WhoisScraper():
    ...
    def scrape(self,website_url):
        ...
        urls_to_try.append("https://rdap.publicinterestregistry.net/rdap/org/domain/" + website_url)
        urls_to_try.append("https://rdap.ca.fury.ca/rdap/domain/" + website_url)
        urls_to_try.append("https://rdap.registrar.amazon.com/rdap/domain/" + website_url)
